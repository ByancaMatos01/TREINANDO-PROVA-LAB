...
*/
SELECT DISTINCT A.NOME_ALUNO, D.NOME_DISCIPLINA FROM TB_ALUNO_DISCIPLINA AD
JOIN TB_ALUNO A ON AD.COD_ALUNO = A.COD_ALUNO
JOIN TB_DISCIPLINA D ON AD.ID_DISCIPLINA = D.ID_DISCIPLINA
WHERE D.NOME_DISCIPLINA IN ('MATEMATICA', 'PORTUGUES')
...
WHERE ID_PROFESSOR IN (
    SELECT DISTINCT ID_PROFESSOR_DISCIPLINA
    FROM TB_DISCIPLINA
